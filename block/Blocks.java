...
public class Blocks {
	...
	public static Block oreChocolate = new BlockOreChocolate(Config.oreChocolateID, Material.clay).setHardness(3.0F).setResistance(5.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("cookieverse:oreChocolate").func_111022_d("cookieverse:oreChocolate").setCreativeTab(Cookieverse.creativeTab);
	public static Block oreWhiteChocolate = new BlockOreChocolate(Config.oreWhiteChocolateID, Material.clay).setHardness(3.0F).setResistance(5.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("cookieverse:oreWhiteChocolate").func_111022_d("cookieverse:oreWhiteChocolate").setCreativeTab(Cookieverse.creativeTab);
	public static Block oreBlackChocolate = new BlockOreChocolate(Config.oreBlackChocolateID, Material.clay).setHardness(3.0F).setResistance(5.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("cookieverse:oreBlackChocolate").func_111022_d("cookieverse:oreBlackChocolate").setCreativeTab(Cookieverse.creativeTab);
	public static Block blockChocolate = new Block(Config.blockChocolateID, Material.clay).setHardness(3.0F).setResistance(10.0F).setStepSound(Block.soundMetalFootstep).setUnlocalizedName("cookieverse:blockChocolate").func_111022_d("cookieverse:blockChocolate").setCreativeTab(Cookieverse.creativeTab);
	...
	public static Block cookieDough = new BlockDough(Config.cookieDoughID, Material.clay).setHardness(0.5F).setStepSound(Block.soundClothFootstep).setUnlocalizedName("cookieverse:cookieDough").func_111022_d("cookieverse:cookieDough").setCreativeTab(Cookieverse.creativeTab);
	public static Block cookie = new BlockCookie(Config.cookieID, Material.clay).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundClothFootstep).setUnlocalizedName("cookieverse:cookie").func_111022_d("cookieverse:cookie").setCreativeTab(Cookieverse.creativeTab);
	public static Block chocolateCookieDough = new BlockDough(Config.chocolateCookieDoughID, Material.clay).setHardness(0.5F).setStepSound(Block.soundClothFootstep).setUnlocalizedName("cookieverse:chocolateCookieDough").func_111022_d("cookieverse:chocolateCookieDough").setCreativeTab(Cookieverse.creativeTab);
	public static Block chocolateCookie = new BlockCookie(Config.chocolateCookieID, Material.clay).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundClothFootstep).setUnlocalizedName("cookieverse:chocolateCookie").func_111022_d("cookieverse:chocolateCookie").setCreativeTab(Cookieverse.creativeTab);
