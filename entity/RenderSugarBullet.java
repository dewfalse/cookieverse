...
public class RenderSugarBullet extends Render {

    private static final ResourceLocation TEXTURE = new ResourceLocation("cookieverse", "textures/entity/sugarBullet.png");

	@Override
	public void doRender(Entity entity, double d0, double d1, double d2,
			float f, float f1) {
		doRenderShurken((EntitySugarBullet) entity, d0, d1, d2, f, f1);

	}

    protected ResourceLocation func_110806_a(EntitySugarBullet par1EntityObon)
    {
        return TEXTURE;

    }

    void doRenderShurken(EntitySugarBullet entity, double d0, double d1, double d2,
			float f, float f1) {
    ...
    {
        return this.func_110806_a((EntitySugarBullet)par1Entity);
    }
