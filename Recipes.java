...
public class Recipes {
	...
	public static void init() {
		...
		GameRegistry.addShapelessRecipe(new ItemStack(Items.itemChocolate, 9),
				Blocks.oreChocolate);

		registerBlockRecipe(Items.itemWhiteChocolate, Blocks.blockWhiteChocolate);
		GameRegistry.addShapelessRecipe(new ItemStack(Items.itemWhiteChocolate, 9),
				Blocks.oreWhiteChocolate);

		registerBlockRecipe(Items.itemBlackChocolate, Blocks.blockBlackChocolate);
		GameRegistry.addShapelessRecipe(new ItemStack(Items.itemBlackChocolate, 9),
				Blocks.oreBlackChocolate);

		registerBlockRecipe(Items.itemCookieDough, Blocks.cookieDough);
		GameRegistry.addSmelting(Blocks.cookieDough, new ItemStack(Blocks.cookie, 1), 0.15F);
		registerBlockRecipe(Items.cookie, Blocks.cookie);

		registerBlockRecipe(Items.itemChocolateCookieDough, Blocks.chocolateCookieDough);
		GameRegistry.addSmelting(Blocks.chocolateCookieDough, new ItemStack(Blocks.chocolateCookie, 1), 0.15F);
		...
		GameRegistry.addSmelting(Blocks.whiteChocolateCookieDough, new ItemStack(Blocks.whiteChocolateCookie, 1), 0.15F);
		...
		GameRegistry.addSmelting(Blocks.blackChocolateCookieDough, new ItemStack(Blocks.blackChocolateCookie, 1), 0.15F);
		...
		GameRegistry.addSmelting(Items.itemCookieDough, new ItemStack(Items.cookie, 1), 0.01F);
		GameRegistry.addSmelting(Items.itemChocolateCookieDough, new ItemStack(Items.itemChocolateCookie, 1), 0.01F);
		GameRegistry.addSmelting(Items.itemWhiteChocolateCookieDough, new ItemStack(Items.itemWhiteChocolateCookie, 1), 0.01F);
		GameRegistry.addSmelting(Items.itemBlackChocolateCookieDough, new ItemStack(Items.itemBlackChocolateCookie, 1), 0.01F);
	...
	private static void registerBlockRecipe(Item item, Block block) {
		...
		GameRegistry.addShapelessRecipe(new ItemStack(item, 9),
				block);
